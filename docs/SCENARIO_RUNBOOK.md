...
- commute enabled via `business` or `workcation`
...
- Denver: full success
- Sydney: full success, despite one recoverable Google Maps tool error in commute research
...
2. run stays, neighborhood, activities, food, weather, commute, and optional flights
...
- commute options for two destinations
...
uv run python scripts/debug_agent.py --agent commute --input docs/scenarios/lisbon_workcation_roundtrip.json
